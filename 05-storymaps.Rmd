...
```{r mapbox3, echo=F, fig.align="center", out.width="50%", fig.show='hold', fig.cap="Komponendid ja kihid"}
...
```{r mapbox12, echo=F, fig.align="center", out.width="70%",fig.show='hold', fig.cap="Kaardi salvestamine"}
