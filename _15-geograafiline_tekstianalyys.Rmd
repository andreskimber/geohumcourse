...
```{r mappinglakes1, echo=F, fig.align="center", fig.cap="Mapping the Lakes: kahe poeedi reisikirjeldustes mainitud kohtade võrdlus [@Gregory&Cooper2009]", out.width="70%"}
...
```{r lakedistrict1, echo=F, fig.align="center", fig.cap="Inglismaa Lake District ehk Järvemaa piirkond (© User:Diliff / Wikimedia Commons / CC-BY-SA-3.0)", out.width="70%"}
...
```{r geoparsing, echo=F, fig.align="center", fig.cap="Geoparsimine ühendab kohanimede tuvastamise ja koordinaatidega sidumise ([@Gritta2017])", out.width="70%"}
...
```{r london, echo=F, fig.align="center", fig.cap="Londoni kujutamine kirjanduses ([@Heuser2016])", out.width="80%"}
...
```{r mappinglakes2, echo=F, fig.align="center", fig.cap="Kohtadest kirjutamine ja maastikud ([@Murrieta-Flores2017])", out.width="70%"}
