...
```{r bornhohe1, echo=F, fig.show='hold', fig.align='center', out.width= "70%", fig.cap= '"Vürst Gabriel ehk Pirita kloostri viimsed päevad" lähtetekst'}
...
```{r excel1, echo=F, fig.show='hold', fig.align='center', out.width= "70%", fig.cap= 'Teksti meelsuse tuvastamine'}
...
```{r bornhohe2, echo=F, fig.show='hold', fig.align='center', out.width= "70%", fig.cap= "Geokodeerimise sätted"}
...
```{r qgis1, echo=F, fig.show='hold', fig.align='center', out.width= "70%", fig.cap= "Andmekihid QGISis"}
...
```{r qgis2, echo=F, fig.show='hold', fig.align='center', out.width= "70%", fig.cap= "Kohanimede mainimiste kokkulugemine SQLiga"}
...
```{r qgis3, echo=F, fig.show='hold', fig.align='center', out.width= "70%", fig.cap= "Punktide ja teksti suuruse muutmine vastavalt andmestiku tunnusele"}
...
```{r qgis4, echo=F, fig.show='hold', fig.align='center', out.width= "70%", fig.cap= "Kohanimede mainimiste kokkulugemine vastavalt emotsioonile"}
...
```{r qgis5, echo=F, fig.show='hold', fig.align='center', out.width= "70%", fig.cap= "Andmekihtide ühendamine"}
...
```{r qgis6, echo=F, fig.show='hold', fig.align='center', out.width= "70%", fig.cap= "Punktide visualiseerimine kategoorilise ja arvulise tunnuse järgi"}
...
```{r qgis7, echo=F, fig.show='hold', fig.align='center', out.width= "70%", fig.cap= "Punktide jaotumise heatmap"}
