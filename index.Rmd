...
- Nädalad 4.-9., 11.-16. **Praktikume ei toimu 1. ja 4. novembril!**  
- Jakobi 2-106  
- Kontakt ja info: [andres.kimber\@ut.ee](mailto:andres.kimber@ut.ee){.email}, [maarja-liisa.pilvik\@ut.ee](mailto:maarja-liisa.pilvik@ut.ee){.email}  
...
- Kohalkäimine ei ole kohustuslik, ent tungivalt soovituslik. Mis tahes haigusnähtude ilmnemisel jää siiski koju.  
...
Palun vasta lühikesele [küsimustikule](https://docs.google.com/forms/d/e/1FAIpQLSf15amEnGuTpFHmalIDvrjy_yQQrt4QoluhkcWGISLi9YoFpA/viewform), millele toetudes lepime kokku selles, kas või millistel tingimustel kanname praktikumides maske.  
...
```{r koolerakaart, echo = FALSE, fig.align = 'center', out.width = "100%", fig.cap = "John Snow koolera leviku kaart (1855) ([Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Snow-cholera-map.jpg))"}
knitr::include_graphics(here::here("imgs", "Snow-cholera-map.jpg"))
```
...
```{r arheo-example, echo = FALSE, fig.show='hold', fig.align = 'default', out.width = "100%", fig.cap = "Muististe jaotumise visualiseerimine  ja maastiku nähtavuse analüüsimine [@Kimber2016]"}
