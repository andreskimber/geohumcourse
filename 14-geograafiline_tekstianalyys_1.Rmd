...
```{r geoparsing, echo=F, fig.align="center", fig.cap="Geoparsimine ühendab kohanimede tuvastamise ja koordinaatidega sidumise [@Grittaetal2018]", out.width="70%"}
...
<br>
<br>
*Annely Peebo was born on November 16, 1971 in Võhma. She studied choir conducting and piano in Tallinn and singing in Vienna. In the second half of the 90's he moved from Estonia to Austria. She has starred in a French film and hosted the 2002 Eurovision Song Contest in Tallinn. I don't know whether she has ever sung in Tartu.* 
<br>
<br>
...
Võta tekst *Gray_cqp_13.txt* ja ürita saada sellest veebiparserite abil kätte kohanimed ja nende koordinaadid.
...
Geokodeeri MMQGISi plugina abil fail *Gray_cqp_13.csv*, kus on kõik Gray tekstis esinenud kohanimed (käsitsi märgendatud).
