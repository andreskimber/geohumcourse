...
```{r satelliit, echo=F, fig.show='hold', fig.align='center', out.width= "100%", fig.cap= "EstCube-1 tehtud satelliitpilt ([https://www.estcube.com/](https://www.estcube.com/))"}
knitr::include_graphics(here::here("imgs", "estcube1.png"))
```
...
```{r arheo-ex, echo = FALSE, fig.show='hold', fig.align = 'center', out.width = "100%", fig.cap = "Maastiku nähtavuse analüüsimine [@Kimber2016]"}
...
```{r, echo = FALSE, fig.show='hold', fig.align = 'center', out.width = "100%", fig.cap = "Tänavaröövid Saitamas [@Okabe2006 : 8]"}
