...
```{r map-types, echo = F, fig.align="center", out.width = "70%", fig.cap = "[Types of Maps](https://geology.com/maps/types-of-maps/)"}
knitr::include_graphics(here::here("imgs", "types-of-maps.jpg"))
```

```{r parismetro, echo = F, fig.align="center", out.width = "80%", fig.cap = "[Pariisi metrookaart](http://www.urbanrail.net/eu/fr/paris/paris.htm/)"}
...
library(vembedr)
library(htmltools)
embed_url("https://youtu.be/rblfKREj50o?t=138")
```
...
```{r projektsioonipered, echo = FALSE, fig.show = "hold", fig.align = "center", out.width = "80%", fig.cap="Projektsioonitüübid [@Aunap2019: 169]"}
...
library(vembedr)
library(htmltools)
embed_url("https://www.youtube.com/watch?v=vVX-PrBRtTY")
```


Vaatame mõningaid näiteid sellest, kuidas projektsioonid moonutavad kaardil kujutatut. 

```{r mathigon, echo = FALSE, fig.show='hold', fig.align='center', out.width= "70%", out.height = "70%", fig.cap= "Projektsioonide tõttu esinev moonutus (allikas: [mathigon.org](https://mathigon.org/course/circles/spheres-cones-cylinders#sphere-maps))"}
knitr::include_graphics(here::here("imgs", "4_mathigon.PNG"))
```

Riikide suurused erinevates asukohtades rakenduses [The True Size](https://thetruesize.com/). Maa pöörlemine erinevates projektsioonides kujutatult rakenduses [Map Projection Transitions](https://www.jasondavies.com/maps/transition/).
...
```{r bonneprojection, echo = FALSE, fig.show = "hold", fig.align = "center", out.width = "70%", out.height = "70%", fig.cap = "Bonne'i pseudokooniline projektsioon, mille keskmesse on pandud Tartu (allikas: [twitter.com/evelynuuemaa](https://twitter.com/evelynuuemaa/status/1196353283696316416))"}
...
```{r protokoll, echo = F, fig.align = "center", fig.show='hold', out.width= "80%", fig.cap= "Vallakohtuprotokolli näide xml-kujul [@Pilvik2019]"}
