...
```{r mymaps, echo = FALSE, fig.show='hold', fig.align='center', out.width= "50%", out.height = "100%", fig.cap= "Kaardi tegemine Google My Mapsis"}
knitr::include_graphics(c("imgs/okt01_gif/gmaps1.gif", "imgs/okt01_gif/gmaps2.gif", "imgs/okt01_gif/gmaps3.gif", "imgs/okt01_gif/gmaps4.gif"))
```
