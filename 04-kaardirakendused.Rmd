...
```{r noored, echo = F, fig.align="center", out.width = "100%", out.height = "100%", fig.cap = "[Marleen Eino Tartu kaart](https://tntk.tartu.ee/tartu-noorsootoo-keskus/reveal-youropean-cultural-heritage-enrich/tartu-kaart/)"}
...
```{r leaflet, echo=F, message = F, fig.show="hold", fig.align="center", warning=F}
library(leaflet)
library(leafem)
library(dplyr)
