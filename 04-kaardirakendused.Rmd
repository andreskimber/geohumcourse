...
Vaatame mõningate näidete abil, kuidas projektsioonid moonutavad kaardil kujutatut. 

```{r mathigon, echo = FALSE, fig.show='hold', fig.align='center', out.width= "70%", out.height = "70%", fig.cap= "Projektsioonide tõttu esinev moonutus [mathigon.org](https://mathigon.org/course/circles/spheres-cones-cylinders#sphere-maps)"}
